...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BA_MyCustomAdapter01 listAdapter = new BA_MyCustomAdapter01(MainActivity.this, headline, imageId, date, repname, details);
        list.setAdapter(listAdapter);
//
//        spinner = (Spinner) findViewById(R.id.spinner);
//        BA_MyCustomAdapter01 spinnerAdapter = new BA_MyCustomAdapter01(MainActivity.this, headline, imageId, date, repname);
